...
const GLOSSARY = [
  ...
  ['Bid', 'Spring: your face-down card competing for Kingdom Cards. Only its Strength counts. Highest resolves first; take a card, steal one, or take your card back.', 'v'],
  ...
  ['Council', 'Three seats of power: Relics (Influence via Herald Rewards), Secrets (Location Rewards without winning), Oaths (recover Supporters). Govern to add cards; their Votes fuel the Council’s ability.', 'M'],
